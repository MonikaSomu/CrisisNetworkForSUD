...
public class PatientHomePage extends AppCompatActivity {
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Location>() {
                        ...
                        public void onSuccess(Location locationGPS) {
                            ...
                            if (locationGPS != null) {
                                ...
                                Toast.makeText(PatientHomePage.this, "UNABLE TO FIND LOCATION", Toast.LENGTH_SHORT).show();
                            }
                        }
                    })
    ...
    private ArrayList<String> loadContact() {
        ...
        Cursor data = myDB.getListContents();
        if (data.getCount() == 0) {
            Toast.makeText(PatientHomePage.this, "There is no content", Toast.LENGTH_SHORT).show();
        } else {
            while (data.moveToNext()) {
                theList.add(data.getString(1));
            }
